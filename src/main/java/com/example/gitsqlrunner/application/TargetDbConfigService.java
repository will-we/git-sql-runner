...
public class TargetDbConfigService {
  ...
  private TargetDbPayload normalizePayload(TargetDbPayload payload, TargetDatabase current) {
    ...
    return new TargetDbPayload(targetId, name, dbType, host, payload.port(), databaseName, username, password == null ? "" : password, jdbcParams, payload.enabled());
  }
  ...
  public static final class TargetDbPayload {
    ...
    public TargetDbPayload(String targetId, String name, String dbType, String host, Integer port, String databaseName, String username, String password, String jdbcParams, boolean enabled) {
